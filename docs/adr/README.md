...
| [0024](0024-mutations-via-dash-templates.md)        | Mutations via DASH construct templates                                       | Writes-era decision: template-named commands, two-step execution, skolemized dry-run        | Proposed (rev. 3)   |
